...
| T4 | **Médio** | Canonical da home é `https://www.aprovaoab.app.br` (sem barra), o sitemap declara `https://www.aprovaoab.app.br/` (com barra), e `og:url` também vem sem barra. Inconsistência de normalização. |
