...
/**
 * Path do ícone do WhatsApp. Mora aqui porque são ~700 caracteres e passaram a
 * ter DOIS consumidores — o botão flutuante da landing e o rodapé. O
 * `lucide-react` não traz marcas, então é SVG inline; duplicar a string é como
 * `iniciaisDoNome` acabou em quatro cópias que divergiram entre si.
 */
